...
# Create data loader
trainset = create_dataset(COCOStuff, labels='/n/fs/context-scr/labels_train_80.pkl', B=100, baseline1=True, biased_classes_mapped=biased_classes_mapped) # instead of 200
valset = create_dataset(COCOStuff, labels='/n/fs/context-scr/labels_train_20.pkl', B=500, baseline1=True, biased_classes_mapped=biased_classes_mapped)
...
outdir = '/n/fs/context-scr/nmeister/save/baseline1_80_20'
if not path.isdir(outdir):
    mkdir(outdir)
    print('Created', outdir, '\n')

# Start baseline 1 training
...
for i in range(Classifier.epoch, nepochs):
    ...
    if (i+1)%5 == 0:
        Classifier.save_model('{}/baseline1_{}.pth'.format(outdir, i))
