...
if arg['model'] in ['baseline', 'removeclabels', 'removecimages', 'splitbiased', 'cam', 'featuresplit']:
    ...
    labels_list, scores_list, val_loss_list = classifier.test_negativepenalty(testset, biased_classes_mapped, penalty=10)
elif arg['model'] == 'classbalancing':
    labels_list, scores_list, val_loss_list = classifier.test_classbalancing(testset, biased_classes_mapped, weight)
